...
mixin _$ImageStore on _ImageStoreBase, Store {
  late final _$imageFileAtom = Atom(
    name: '_ImageStoreBase.imageFile',
    context: context,
  );
  ...
  late final _$descriptionAtom = Atom(
    name: '_ImageStoreBase.description',
    context: context,
  );
  ...
  late final _$clothingDescriptionAtom = Atom(
    name: '_ImageStoreBase.clothingDescription',
    context: context,
  );
  ...
  late final _$analysisResultAtom = Atom(
    name: '_ImageStoreBase.analysisResult',
    context: context,
  );
  ...
  late final _$isLoadingAtom = Atom(
    name: '_ImageStoreBase.isLoading',
    context: context,
  );
  ...
  late final _$errorMessageAtom = Atom(
    name: '_ImageStoreBase.errorMessage',
    context: context,
  );
  ...
  late final _$pickFromCameraAsyncAction = AsyncAction(
    '_ImageStoreBase.pickFromCamera',
    context: context,
  );
  ...
  late final _$pickFromGalleryAsyncAction = AsyncAction(
    '_ImageStoreBase.pickFromGallery',
    context: context,
  );
